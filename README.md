...
3. Removed unwanted columns (e.g., grading date, unused IDs, comments).
...
4. Load into Power BI for visualization.
...
link  : https://github.com/saikumar-data/coffee-quality-analysis/blob/main/dashboard.png
